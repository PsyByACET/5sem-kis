...
class Contract(models.Model):
    ...
    agent = models.CharField(db_column='Agent', max_length=45, blank=True, null=True, verbose_name="Агент")  # Field name made lowercase.
...
class Deal(models.Model):
    ...
    status_deal = models.CharField(db_column='Status_deal', max_length=9, blank=False, null=True, verbose_name="Статус сделки")  # Field name made lowercase.
